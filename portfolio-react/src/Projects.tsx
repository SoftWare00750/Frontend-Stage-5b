  ...
  return (
    <div
      ...
      style={{
        ...
        background: 'var(--bg2)',
        border: `1px solid ${hovered ? 'rgba(124,106,245,0.4)' : 'var(--border)'}`,
        borderRadius: '12px',
        overflow: 'hidden',
        transition: 'all 0.3s',
        cursor: 'pointer',
    ...
    >
      ...
      <div style={{ padding: '1.5rem' }}>
        ...
        <p style={{ color: 'var(--text2)', fontSize: '0.85rem', lineHeight: 1.7, marginBottom: '1.2rem' }}>
          {project.desc}
        </p>
        ...
        <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap', marginBottom: '1.3rem' }}>
          {project.tags.map(tag => (
            <span key={tag} style={{
              ...
              fontSize: '0.7rem', color: 'var(--accent2)',
            }}>
              {tag}
            </span>
          ))}
  ...
  return (
    <section id="work" style={{ padding: '7rem 3rem', background: 'var(--bg)' }}>
      <div style={{
        ...
        marginBottom: '0.8rem', display: 'flex', alignItems: 'center', gap: '0.8rem',
      }}>
        <span>//</span> 02 — Work
      </div>
      ...
      <p className="reveal" style={{
        ...
        A curated selection of work I'm proud of. From real-time data dashboards
